...
var outMgr = {
	...
	fStrings : ["scroll up","Scroll up the menu",
	/*02*/      "scroll down","Scroll down the menu",
	/*04*/      "Hide the outline","Show the outline",
	/*06*/      "Hide/show the outline","",
	/*08*/      "Open the menu \'%s\'","Close the menu \'%s\'"],
