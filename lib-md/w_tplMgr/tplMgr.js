...
var tplMgr = {
	...
	fStrings : ["Enlarge","Hide some interface elements to enlarge the content",
	/*02*/      "Restore","Restore default interface.",
	/*04*/      "Hide the content of \'%s\'","Show the content of \'%s\'",
	/*06*/      "Dynamic resource loading is disabled.\n\nYour browser security restrictions prevent the use of features such as search or menu browsing.",""],
