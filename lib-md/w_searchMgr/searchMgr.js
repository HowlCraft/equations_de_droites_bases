...
var searchMgr = {
	...
	fStrings : ["Cancel","Cancel the search",
  /*02*/    "Launch the search","No results.",
  /*04*/    "One page found","%s pages found",
  /*06*/    "Narrow your search...","Searched terms:",
  /*08*/    "Previous","Previous occurance",
  /*10*/    "Next","Next occurance",
  /*12*/    "Previous page","Next page",
  /*14*/    "List","Show/hide the list of matching pages",
  /*16*/    "pertinence:%s/9","",
  /*18*/    "","%s",
  /*20*/    "No search results","Search",
  /*22*/    "Open the menu","Close the menu"],
