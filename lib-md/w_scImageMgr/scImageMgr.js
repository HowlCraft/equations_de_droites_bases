...
scImageMgr.fStrings = ["previous","previous picture (left arrow)",
/*02*/               "next","next picture (right arrow)",
/*04*/               "close","close the slideshow (Esc)",
/*06*/               "launch","launch slide-show (p)",
/*08*/               "stop","stop slide-show (p)",
/*10*/               "Loading. Please wait.","",
/*12*/               "previous","previous picture",
/*14*/               "next","next picture",
/*16*/               "launch","launch the animation",
/*18*/               "stop","stop the animation",
/*20*/               "start","go to the beginning of the animation",
/*22*/               "end","go to the end of the animation",
/*24*/               "speed","change the speed of the animation",
/*26*/               "image","Consult the diaporama from:",
/*28*/               "loop","play (continuous loop)",
/*30*/               "close","close the zoom (Esc)",
/*32*/               "zoom on the image",""];
/** scImageMgr.init. */
